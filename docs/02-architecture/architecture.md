...
Profiles should primarily reference Presets.
...
Policies are resolved independently from Profiles.
...
Profile and Preset expansion should happen before implementation selection.
