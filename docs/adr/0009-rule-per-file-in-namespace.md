...
- Gặp file có `applyTo` hoặc đuôi `.instructions.md` thì `ap` cảnh báo. Muốn hỗ trợ sau này thì thêm một trường (vd. `format`) vào Rule declaration mà không phá vỡ gì.
